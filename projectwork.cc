...
void addstudent() 
{
    ...
    student s;
    ofstream outputfile;
    cout<< "\npress 1 again to confirm add student: ";cin>>choice;
    for (i=0; choice!='n'&&choice!='N'; i++){
            if((choice=='y')||(choice=='Y')||(choice=='1')){

    cout<< "\n\n\t\t\tADD STUDENT"<<endl;
    cout<<"\tId number: "; cin>>s.id;
    cout<<"\tFirst Name: "; cin>>s.firstname;
    cout<<"\tLast Name: "; cin>>s.lastname;
    cout<<"\tClass: "; cin>>s.clas;
    cout<<"\tSex: "; cin>>s.sex;
    cout<<"\tAge: "; cin>>s.age;

    //output to student file.
    outputfile.open("student.txt",ios::app);
    outputfile<<s.id<<" "<<s.firstname<<" "<<s.lastname<<" "<<s.clas<<" "<<s.sex<<" "<<s.age<<endl;
    outputfile.close();
    cout<<"\n\n\t\t\tStudent has been Added!!!.\n";
    cout<<"\n\n\n\npress 'Y' to add another student or 'N' to finish: "; cin>>choice;
...
void studentsrecordlist()
{
    ...
    cout <<setw(15) <<"ID"<<setw(15)<<"FIRST_NAME"<<setw(15)<<"LAST_NAME"<<setw(20)<<"COMPUTER SCIENCE"<<setw(15)<<"MATHS"<<setw(15)<<"PROGRAMMING"<<setw(15)<<"COMPUTER ARCHITURE"<<setw(15)<<"CRITICAL THINKING"<<endl<<endl;
    string line;
    while(std::getline(outputfile, line))
    {
        istringstream ss(line);
...
int main()
{
    ...
    while(1)
    {
            ...
            cout <<endl<<endl;
            cout<<"  \t\t\t\tSCHOOL MANAGEMENT DATABASE"<<endl;
                ...
                case 2:
                     ...
                     case 3:
                            ...
                            switch(couselect)
                            {
                                ...
                                break;
                                default:
                                        cout<<"!!!wrong entry. Enter a number between 1-5!!!";
                            }
